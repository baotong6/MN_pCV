...
\\
19 & $1.82^{+0.10}_{-0.10}$ & 40 (fixed)  & $0.050^{+0.043}_{-0.024}$& 0.95/185  & $93.2^{+3.61}_{-3.51}$
\\
20 & $2.09^{+2.45}_{-1.16}$ & $4.04^{+28.2}_{-2.54}$ &-& 1.04/12  & $5.99^{+2.01}_{-1.64}$
\\
21$^\ddag$ & $2.83^{+0.25}_{-0.23}$ & 40 (fixed)  & $0.23^{+0.05}_{-0.02}$ & 1.10/147  & $66.7^{+3.61}_{-3.47}$
\\
22$^\ddag$ & $2.83^{+0.25}_{-0.23}$ & 40 (fixed)  &  $0.23^{+0.05}_{-0.02}$ & 1.10/147  & $66.7^{+3.61}_{-3.47}$
\\
23 & $1.83^{+0.44}_{-0.37}$ & 40 (fixed)  & $ 0.47^{+0.42}_{-0.44}$  & 1.47/35  & $10.3^{+1.36}_{-1.25}$
\\
