...
\hline
\hline
ID & $N_{\rm H}$ & $T_{\rm b}$ &  $EW_{6.7}$ & $\chi^2$/d.o.f & $L_{\rm 1-8}$ 
\\
(1) & (2) & (3) & (4) & (5) & (6) 
\\
...
(3) The bremsstrahlung temperature. Fixed at 40 keV when the spectrum provides no significant constraint to this parameter.
 (4) Equivalent width of the 6.7 keV line.
 (5) $\chi^2$ and degree of freedom of the best-fit model.
 (6) 1--8 keV unabsorbed luminosity, corrected for the enclosed-energy fraction. All quoted errors are at the 90\% confidence level. Upper limits are at 3\,$\sigma$ significance.
\end{tablenotes} 
\end{threeparttable}
\end{table*} 
