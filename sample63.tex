...
This stems from the empirical fact that the coronal X-ray emission from low-mass stars saturates at $\sim$10$^{-3}$ of the bolometric luminosity {\bf (G{\"u}del 2004)}
...
Thus the light curve shape of IPs are complex and can exhibit both sinusoidal variations and dips,  Examples of this kind are found in sources \#2, \#3, \#7, \#11, \#18 and \#20
%seem to possess sinusoidal variations plus dips at occasional phase, better be explained as orbital variation with obscuration by the accretion stream.
In addition, source \#19, which has the highest X-ray luminosity with only moderate sinusoidal variation, is most likely an IP.
...
{\bf [Comment on the non-detection of spin period for the IP candidates? \#2 is more likely the spin period. Why no orbital period?]}
...
However, the near-zero flux for half-cycle is unusual for ABs. One possibility is that this system consists of a Sun-like star and an A-star, the latter producing no significant X-rays due to a very weak surface magnetic field {\bf (G\''{u}del 2004)}. 
