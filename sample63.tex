...
Again, we take the 90\% probability threshold and an period accuracy of 0.1\% to define a valid detection. The percentage of valid detections, $P_{det}$ (see column 9 in Table \ref{tab:src}), is plotted in Figure \ref{fig:com}. 
