...
The phase-folded light curves are complemented by the long-term, inter-observation light curve, shown in the left panel and upper right of Figures~\ref{fig:pCV_sample_1} and \ref{fig:pCV_sample_2}. 
...
\label{appen:fig}
  \begin{figure*}
    \centering
    \includegraphics[page=1,scale=0.90,trim=5 70 0 20,clip]{plot_figure_LW.pdf}
