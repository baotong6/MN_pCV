...
While the case is not applicable for source \#24, with luminosity about $\rm 0.77 \times 10^{31}~erg~s^{-1}$ and plasma temperature about 2 keV. All these features are typical for ABs. Besides, its phase-folded light curve exhibits no emission in half of cycle, indicating the similar radius for two stars. The nearly no emission from one star hinted it could be an A-type star. Then the orbit radius would be around 0.022 AU, taking $5M_\odot$ as the total mass.  
