...
Popular catalogs of CVs now include more than one thousand sources with well determined physical properties of the binary system (\citealp{2003A&A...404..301R}; {\bf any other catalogs worth mentioning?}).
...
Empirically, the fraction of magnetic CVs (polars plus IPs) is $\sim$20\% among all known CVs in the solar neighborhood (\citealt{2003A&A...404..301R}), while the intrinsic fraction might be somewhat lower ($\sim$16\%; \citealp{2014MNRAS.442.2580P}).
