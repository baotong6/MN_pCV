...
Popular catalogs of CVs now include more than one thousand {\bf [is this true?]} sources with well determined physical properties of the binary system (\citealp{2003A&A...404..301R}; {\bf any other catalogs worth mentioning?}).
...
%Typical X-ray luminosities of CV range between $10^{30}-10^{34}\rm~erg~s^{-1}$. %are abundant throughout the Galactic disk and bulge, as well as dense environments including the Galactic center (e.g., \citealp{2003ApJ...599..465M,2009ApJS..181..110M,2018ApJS..235...26Z}) and globular clusters (e.g., \citealp{2006ApJ...646L.143P,2018ApJ...858...33C}). 
...
Empirically, the fraction of magnetic CVs (polars plus IPs) is $\sim$20\% among all known CVs in the solar neighborhood (\citealt{2003A&A...404..301R}), while the intrinsic fraction might be somewhat lower ($\sim$16\%; Pretorius \& Mukai 2014).
%more references? Do we also have knowledge on the fraction of magnetic WDs?).      

In CVs, X-rays are almost exclusively produced near the WD surface (\citealp{2001cvs..book.....H}; Mukai 2017). 
