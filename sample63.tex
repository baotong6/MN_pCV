...
In summary, based on the X-ray properties of the periodic sources, in particular their phase-folded light curves, we identify 12 candidate polars, 2 probable plus 7 candidate IPs, one likely DN and one likely AB. 
...
We take $\sum{N_{\rm det,polar}^i} = 19$, effectively counting all the periodic sources except the two probable IPs, one likely AB and one foreground DN (Section~\ref{subsec:class}).
