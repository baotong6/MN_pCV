...
This leads us to consider \#24 a DN. In this case, its sinusoidal light curve may reflect the orbital modulation due to a non-zero ellipticity, which is plausible for long-period orbits. As a supplement, the well-known dwarf nova, SS Aur shares similar properties including an outburst (mean interval of 56 days), long orbital period (4.4 hours) and weak variation in both X-ray (with private) and ultraviolet band (lower than 0.5 mag; \citealt{1983ApJ...271..754W,1986Afz....24..227E}).
