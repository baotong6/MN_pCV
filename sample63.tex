...
\title[Short title, max. 45 characters]{Periodic Cataclysmic Variables in the Galactic Bulge: Application of the Gregory-Loredo Algorithm}
...
%  \captionsetup{list=off,format=cont}
    \centering    \includegraphics[page=1,scale=0.90,trim=0 0 0 70,clip]{plot_figure_LW_sample.pdf}
