...
(i) The short and long orbital periods (below or above 3 hours) are represented by $P$=5540 sec and $P$=45540 sec, respectively. A weight of 60\% (40\%) is assigned to the short (long) period, roughly according to the distribution of solar neighborhood polars; 
...
we are only able to set the sum of $Np_{i}$ smaller than one. Then $\alpha$ would be lower than 53\%.
