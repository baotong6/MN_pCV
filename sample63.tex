...
Therefore, we restrict our period searching to sources with $C \geq 100$, which include 667 of the 847 sources in the raw list. {\bf Among these 667 sources, ??\% (??\%) have total counts more than 500 (1000).}
...
\hline
\hline
ID& R.A. & Decl. & Period & Prob. & $C$ & VI & H-ID  & $P_{\rm det}$ & Harmonics & Identification 
\\
LW & $\circ$ & $\circ$ & (s) & &  & \% & & &
\\ 
...
(7) $\rm VI=S_{max}/S_{min}$, where $\rm S_{max}$ and $\rm S_{min}$ are the maximum and minimum photon fluxes among all the valid detections. For source \#10 and \#25, no VI are provided since the lack of valid detections.
(8) The cross-match results with previous work. $H_{i}$ represents the $i$th source in Table 2 of \cite{2012ApJ...746..165H}.
(9) The detection probability of periodicity based on simulations of 100 sinusoidal light curves for each source in which the amplitude are taken from \cite{2012ApJ...746..165H}.

(10) The note gives the significant harmonic detected by the algorithm.
(11) The identification by the shape of phase-folded light curve, as discussed in Section \ref{subsec:class}.
...
\hline
\hline
ID & $N_{\rm H}$ & $T_{\rm b}$ &  $EW_{6.7}$ & $\chi^2/dof$ & $L_{\rm 1-8}$ 
\\
(1) & (2) & (3) & (4) & (5) & (6) 
\\
LW & $10^{22}\rm~cm^{-2}$ & keV & keV & & $10^{31}\rm~erg~s^{-1}$ 
\\
\hline

1$^\dag$ & $0.51^{+0.75}_{-0.34}$ & 40 (fixed)  & <7.44 & 1.14/5  & $2.02^{+0.71}_{-0.57}$
\\
2 & $2.17^{+0.54}_{-0.46}$ & $20.7^{+56.9}_{-9.92}$ & <1.28 & 0.86/78  & $25.7^{+3.00}_{-2.24}$
\\
3 & $1.34^{+0.70}_{-0.40}$ & $46.4^{+46.1}_{-38.5}$ & <1.37 & 0.98/33  & $7.34^{+1.17}_{-0.86}$
\\
4 & $1.15^{+0.69}_{-0.50}$ & $11.3^{+53.3}_{-4.71}$ & <0.96 & 0.91/27  & $25.0^{+3.27}_{-4.91}$
\\
5 & $1.02^{+0.27}_{-0.23}$ & 40 (fixed) &<1.22 & 1.00/33 &  $6.21^{+0.86}_{-0.78}$
\\
6 & $1.82^{+0.57}_{-0.50}$ & $6.90^{+12.4}_{-2.90}$ 
	& <1.77 & 1.12/42 &  $10.3^{+1.38}_{-1.23}$
\\
7 & $1.62^{+0.62}_{-0.49}$ & $41.6^{+43.0}_{-32.3}$ & < 1.26 & 0.86/39 &  $7.45 ^{+0.99}_{-0.90}$
\\
8 & $2.06^{+1.51}_{-0.94}$ & 40 (fixed) & < 4.89 & 0.93/7 &  $1.96^{+0.60}_{-0.47}$
\\
9 & $1.29^{+1.34}_{-0.67}$ & $20.8^{+95.8}_{-20.8}$ & <2.44 & 1.10/7 &  $3.88^{+1.36}_{-0.96}$
\\
10 & $2.50^{+7.25}_{-1.56}$ & 40 (fixed)  & <7.29 & 0.85/5 &  $2.38^{+1.96}_{-0.84}$
\\
11 & $1.85^{+0.39}_{-0.33}$ & 40 (fixed)  & <1.10 & 1.22/47 &  $10.5^{+1.24}_{-1.14}$
\\
12 & $6.23^{+9.67}_{-3.66}$ & 40 (fixed) &-& 0.78/6 &  $8.42^{+6.40}_{-3.25}$
\\
13 & $0.90^{+0.30}_{-0.24}$ & 40 (fixed) & <2.27 & 1.15/38 &  $9.43^{+1.25}_{-1.16}$
\\
14$^\dag$ & $0.51^{+0.75}_{-0.34}$ & 40 (fixed) &<7.44 &  1.14/5 &  $2.02^{+0.71}_{-0.57}$
\\
15 & $1.46^{+0.48}_{-0.38}$ & 40 (fixed) & <2.12 &  1.16/42 & $14.3^{+1.97}_{-1.79}$
\\
16 & $0.89^{+0.18}_{-0.16}$ & 40 (fixed) & <1.25 &  1.43/51  & $9.41^{+0.98}_{-0.92}$
\\
17 & $2.68^{+0.63}_{-0.52}$ & 40 (fixed)  & <2.87 &  0.75/36 & $12.5^{+1.78}_{-1.61}$
\\
18 & $2.01^{+0.92}_{-0.66}$ & 40 (fixed)  & <2.03 &  0.53/14  & $4.68^{+0.99}_{-0.85}$
\\
19 & $1.82^{+0.10}_{-0.10}$ & 40 (fixed)  & $0.049^{+0.150}_{-0.044}$& 0.95/185  & $93.2^{+3.61}_{-3.51}$
\\
20 & $2.09^{+2.45}_{-1.16}$ & $4.04^{+28.2}_{-2.54}$ & <5.26 & 1.04/12  & $5.99^{+2.01}_{-1.64}$
\\
21$^\ddag$ & $2.83^{+0.25}_{-0.23}$ & 40 (fixed)  & $0.23^{+0.44}_{-0.18}$ & 1.10/147  & $66.7^{+3.61}_{-3.47}$
\\
22$^\ddag$ & $2.83^{+0.25}_{-0.23}$ & 40 (fixed)  &  $0.23^{+0.44}_{-0.18}$ & 1.10/147  & $66.7^{+3.61}_{-3.47}$
\\
23 & $1.83^{+0.44}_{-0.37}$ & 40 (fixed)  & <1.86  & 1.47/35  & $10.3^{+1.36}_{-1.25}$
\\
24 & $0.35^{+0.16}_{-0.13}$ & $4.78^{+3.55}_{-1.58}$ & <2.39 & 1.19/55  & 
$9.70^{+1.22}_{-1.09}$
\\
25 & $0.83^{+3.31}_{-0.83}$ & $2.30^{+1.59}_{-0.85}$ &-&  0.80/2 & $0.84^{+0.34}_{-0.31}$ 
\\
\hline
CV & $1.40^{+0.07}_{-0.07}$ & 40 (fixed) &$0.18^{+0.07}_{-0.03}$ & 1.04/205 & $12.0^{+0.32}_{-0.32}$\\
\hline
\end{tabular}
\end{spacing}
\begin{tablenotes}
      ...
      \item
      Notes: 
      (1) Source sequence number as in Table~\ref{tab:src}. And "CV" denotes for the combined spectra of all periodic sources except for \#21(22) and \#25. 
      {\dag}Sources 1 and 14 are the same source with two different periods; {\ddag}Sources 21 and 22 are the same source with two different periods. 
...
Furthermore, the vast majority of the detected periods fall between 1.1--3.3 hours, roughly overlapping with the well-known orbital minimum and the orbital gap populated by CVs in the solar neighborhood \citep{2003A&A...404..301R}, as illustrated in Figure~\ref{fig:N_P}. 
...
IPs share the above two-pole or one-pole behavior. 
...
In addition, source \#19, which has the highest X-ray luminosity ($9.3\times10^{32}{\rm~erg~s^{-1}}$) with only moderate sinusoidal variation, is most likely the orbital modulation of an IP.
...
It is worth asking, if some of the aforementioned sources (\#3, \#7, \#11, \#18, \#19 and \#20) were indeed IPs, why only their orbital period is detected. One plausible explanation is that their spin period, presumably below $\sim$ 1 hour, escapes detection due to a relatively detection efficiency. Our simulations (\ref{subsec:simulation}) suggest that for moderate total counts and moderate variation amplitude, the detection rate is generally low for short periods. This effect may apply in all those six candidate IPs except \#19, which has total counts of 3402. Perhaps this source has a very low spin modulation due to the ``one-pole'' behavior.
One the other hand, source \#2, which has not been discussed so far, shows a period of 3820.8 sec, significantly lower than the canonical orbital period minimum (65--82 minutes, determined from observations and binary synthesis modelling, e.g.,  \citealp{2009MNRAS.397.2170G,2011ApJS..194...28K}). %but also below the theoretical period minimum of 65 minutes in the standard model \citep{1982ApJ...254..616R}. 
...
It is also noteworthy that only two long ($>3.5$ hours) periods are found among the 22 orbital periods (3 probable spin periods subtracted). This fraction ($\sim$9\%) is significantly smaller than the fraction of long-period CVs in the solar neighborhood ($\sim??\%$ according to the catalog of \citealp{2003A&A...404..301R}, version 7.20). 
This cannot be due to a selection effect of the GL algorithm, because our simulations in Section~\ref{subsec:simulation} show that the detection rate is generally higher for longer periods.
