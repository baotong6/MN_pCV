...
The resultant light curve will look like that of source \#6 {\bf also \#8 and \#10?}, with nearly half of the cycle showing no significant hard X-ray emission \citep{1985A&A...148L..14H}. 
The periods of these sources are consistent with the period range of known polars (Figure~\ref{fig:N_P}).
This so-called ``two-pole'' behavior becomes more complicated if hard X-rays were produced near both poles, in which case the second pole can partially fill the dip, resulting in a light curve like that of \#16. 
