...
We claim a valid detection if the found period has a detection probability greater than 90\% and its value consistent with the input period to within 1\%. Besides, the harmonics have also been considered as valid detection here with the same accuracy threshold, i.e, the deviation between found period and resonance cycle within 1\%.
