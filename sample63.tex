...
We also proved that the Gregory-Loredo (GL) method used in this work has better sensitivity and data usage compared to the Lomb-Scargle (LS) method. In combination with the simulation and the geometry of accretion in CVs, we constrain the proportion of polars to X-ray sources in LW about 18\%. 
...
This then requires $\alpha_{\rm polar} \approx 18\%$. Strictly speaking, this value is an upper limit, since a good fraction of the 20 periodic sources could be IPs and $g_{\rm polar}$ can also be higher than 25\%. 
For comparison, the fraction of polars is 13.5\% among all known CVs in the solar neighborhood as cataloged by \citet{2003A&A...404..301R}.
