...
Moreover, the number of detected source counts is often only moderate. While one can in principle apply binning to get photometric light curve, it takes the price of potentially losing temporal information.  
...
We test three values of the period, $P$=5258, 15258 and 45258 sec and adopt trial mean count rate from 1.0 to 10.0 with interval of 1, added with 15.0 and 20.0 to get the full trend.
