...
\\
24 & 267.83142 &	 -29.65992 & 47317.12 & 0.98850 &- & 138  &-&- &-
\\
\hline
%\hline
...
Again, we take the 90\% probability threshold and an period accuracy of 1\% to define a valid detection. The percentage of valid detections, $P_{det}$ (see column 9 in Table \ref{tab:src}), is plotted in the upper panel of Figure \ref{fig:com}, compared with the detection rate of LS method, taken from \citet{2012ApJ...746..165H}.
...
\begin{figure}
\begin{minipage}[b]{0.45\textwidth}
\includegraphics[scale=0.5]{./figure/sim_LW/Pdet_com.eps}
\includegraphics[scale=0.5]{./figure/LW/P_comp.eps}
\end{minipage}
\caption{The comparison of efficiency(up) and period determined(down) between two methods. For upper panel, the  H-ID is the sequence number given by \citep{2012ApJ...746..165H}, same as column(6) in Table \ref{tab:src} \label{fig:com}.The detection rate of LS method are taken from Table 2 in \citep{2012ApJ...746..165H}. For lower panel, $P_1$ and $P_2$ denotes for period determined by GL and LS method, respectively.}
\end{figure}
\begin{figure}
